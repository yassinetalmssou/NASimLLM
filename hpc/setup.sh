...
echo "  cd $PROJECT_DIR"
echo "  bash hpc/launch.sh"
echo ""
echo "Then submit the generated job arrays:"
echo "  sbatch --array=1-12 hpc/jobs/rq1.sh  \$VSC_SCRATCH/runs/rq1/commands.txt"
echo "  sbatch --array=1-12 hpc/jobs/rq2.sh  \$VSC_SCRATCH/runs/rq2/commands.txt"
echo "  sbatch --array=1-15 hpc/jobs/rq3b.sh \$VSC_SCRATCH/runs/rq3b/commands.txt"
echo ""
echo "Monitor jobs:"
echo "  squeue -u \$USER"
